...
const Navbar = memo(() => {
  ...
  const totalCount = useMemo(() => getCart().reduce(
  ...
  return (
    <nav className={cls.links}>
      <div className={cls.linkWrapper}>
        <Link to="/favorites">
          <svg className={cls.favorite} width="23" height="20" viewBox="0 0 23 20" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className={cls.countInfo}>0</div>
      </div>
      <div className={cls.linkWrapper}>
        <Link to="/cart">
          <svg className={cls.shoppingCart} width="24" height="25" viewBox="0 0 24 25" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className={cls.countInfo}>{totalCount}</div>
      </div>
    </nav>
  );
});
